...
.card {
	...
	position: relative;
	padding: 25px;
	background: radial-gradient(178.94% 106.41% at 26.42% 106.41%, #FFF7B1 0%, rgba(255,
		255, 255, 0) 71.88%)
		/* warning: gradient uses a rotation that is not supported by CSS and may not behave as expected */,
		#FFFFFF;
	box-shadow: 0px 155px 62px rgba(0, 0, 0, 0.01), 0px 87px 52px
		rgba(0, 0, 0, 0.05), 0px 39px 39px rgba(0, 0, 0, 0.09), 0px 10px 21px
...
<body class="overflow">
	...
	<!--  Code to Retrieve User Count -->
	<%
	AdminServices as = new AdminServices();
	int ucount = as.userCount();
	%>

	<!--  Code to Retrieve Hotel Count -->
	<%
	int hotelCount = 0;
	...
	<!--  Code to Retrieve Reservation Count -->
	<%
	...
	<div class="content ">
		...
		<div class="dashboard ">
			...
			<div class="card">
				...
				<div>
					<a href="AddHotel.jsp"><button class="btn" type="button">Add
							Hotel</button></a>
				</div>
			</div>
			...
			<div class="card">
				...
				<div>
					<a href="AddRoom.jsp"><button class="btn" type="button">Add
							Room</button></a>
				</div>
			</div>
			...
			<div class="card">
				...
				<div>
					<a href="AdminReservation.jsp"><button class="btn"
							type="button">Reservations</button></a>
				</div>
			</div>
